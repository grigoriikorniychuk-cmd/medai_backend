"""
Пересчёт администраторов за 27-28 января 2026 через gpt-5-mini.
Запуск: python -m scripts.recalc_admins_jan27_28
"""
...
# Переопределяем MongoDB URI на удалённый сервер
...
DATE_MAP = {
    "2026-01-27": date(2026, 1, 27),
    "2026-01-28": date(2026, 1, 28),
}
