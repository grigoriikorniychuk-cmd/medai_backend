...
TARGET_DATE_STR = "2025-10-19"

# Конфигурация конверсии для клиники Киров
PIPELINE_PRIMARY_ID = 6869034
STATUS_PRIMARY_BOOKED_ID = 57882910
PIPELINE_SECONDARY_ID = 6888086
STATUS_SECONDARY_BOOKED_ID = 58011926

CONFIRMATION_FIELD_ID = 1054011
CONFIRMATION_VALUE_ID = 1144793

OUTPUT_FILE = "test_conversion_results_17_10.json"

DEBUG_LEAD_ID = 23243211
...
async def check_conversion_for_lead(client, lead_id, call_date, confirmation_value_id, *, diagnostic=False):
    ...
    try:
        ...
        # 2. Проверяем кастомное поле Подтверждение
        for ev in cf_events:
        ...
        # 2.1. Резерв: по состоянию сделки, если нет событий
        try:
...
async def main():
    ...
    print(f"{'='*60}")
    print(f"Клиника: {TARGET_CLIENT_ID}")
